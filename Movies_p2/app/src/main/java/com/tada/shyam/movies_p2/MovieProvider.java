...
import static com.tada.shyam.movies_p2.MovieContract.MOVIES_CONTENT_URI;
import static com.tada.shyam.movies_p2.MovieContract.MOVIE_AUTHORITY;
import static com.tada.shyam.movies_p2.MovieContract.PATH_MOVIE;
...
public class MovieProvider extends ContentProvider {
    ...
    private static UriMatcher buildUriMatcher() {
        ...
        matcher.addURI(MOVIE_AUTHORITY, PATH_MOVIE, CODE_MOVIE);
        matcher.addURI(MOVIE_AUTHORITY, PATH_MOVIE + "/#", CODE_MOVIE_WITH_ID);
        return matcher;
    }
